...
"choking-injury.md": {
	id: "choking-injury.md";
  slug: "choking-injury";
  body: string;
  collection: "services";
  data: InferEntrySchema<"services">
} & { render(): Render[".md"] };
"failure-to-monitor.md": {
	id: "failure-to-monitor.md";
  slug: "failure-to-monitor";
  body: string;
  collection: "services";
  data: InferEntrySchema<"services">
} & { render(): Render[".md"] };
...
"medication-errors.md": {
	id: "medication-errors.md";
  slug: "medication-errors";
  body: string;
  collection: "services";
  data: InferEntrySchema<"services">
} & { render(): Render[".md"] };
"nursing-home-abuse.md": {
	id: "nursing-home-abuse.md";
...
"slip-and-fall-injury.md": {
	id: "slip-and-fall-injury.md";
  slug: "slip-and-fall-injury";
  body: string;
  collection: "services";
  data: InferEntrySchema<"services">
} & { render(): Render[".md"] };
"wandering-and-elopement.md": {
	id: "wandering-and-elopement.md";
  slug: "wandering-and-elopement";
  body: string;
  collection: "services";
  data: InferEntrySchema<"services">
} & { render(): Render[".md"] };
"wrongful-death-claims.md": {
	id: "wrongful-death-claims.md";
